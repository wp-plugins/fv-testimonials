...
class FPTImage {
   ...
   public function CreateResizedImagePNG( $strSource, $strPath, $iWidth, $iHeight, $bTransform = true, $iColorsAtMax = 5000 ){
      ...
      global $objFPTMain;
      imagepng( $imgDest, $_SERVER['DOCUMENT_ROOT'].$objFPTMain->strImageRoot.$strPath, 9 );
   ...
   public function CreateResizedImageGIF( $strSource, $strPath, $iWidth, $iHeight ){
      ...
      global $objFPTMain;
      imagegif( $imgDest, $_SERVER['DOCUMENT_ROOT'].$objFPTMain->strImageRoot.$strPath, 9 );
   ...
   public function CreateResizedImageJPG( $strSource, $strPath, $iWidth, $iHeight, $iJPGQuality ){
      ...
      global $objFPTMain;
      imagejpeg( $imgDest, $_SERVER['DOCUMENT_ROOT'].$objFPTMain->strImageRoot.$strPath, $iJPGQuality );
   ...
   public function CreateResizedImage( $strSize, $iDestWidth, $idTestimonial = 0, $iJPGQuality = 80 ){
      ...
      @chmod( $_SERVER['DOCUMENT_ROOT'].$objFPTMain->strImageRoot.$strPath, octdec( '0'.'777' ) );
